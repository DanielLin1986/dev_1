...
<?php
	...
	if(is_mobile()){
		echo "<script language='javascript' type='text/javascript'>location.href='phone/index.html'</script>";
	} else {
		echo "<script language='javascript' type='text/javascript'>location.href='web/index.html'</script>";
	}
